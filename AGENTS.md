...
- La suite core se ejecuta con `cd p2p-client && mvn test` (362 tests default, 0 failures; 407 total con `-Pperformance-tests`). Incluye tests de i18n para columnas de tabla (`FileTableModelI18nTest`), tests de regresión para los BUGS críticos (BUG-1 a BUG-5), `SecureIdentityStoreTest` (7), `InviteCodeTest` (7), `NotesEditorTest` (5, PENDIENTE-11 parcial), `QfolderLayoutTest` (12), `FileSystemEventStoreTest` (9), `FileSystemFileChunkStoreTest` (8), `CoreChunkTransferProtocolTest` (10), `PerformanceMetricsTest` (8), `P2PNetworkAdapterTest` (15), `P2PMeshServiceTest` (15), `DirectBootstrapTest` (7), `WsClientTest` (9), `EmbeddedWebSocketServerTest` (7) y `CloudflareTunnelTest` (7).
